    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 transition-all duration-500 ease-in-out ${showFilter ? 'opacity-100 max-h-[500px]' : 'opacity-0 max-h-0 overflow-hidden'} sm:opacity-100 sm:max-h-none sm:block`}>
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 cursor-pointer" value={'Men'} onChange={handleCategoryChange} />Men
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 cursor-pointer" value={'Women'} onChange={handleCategoryChange} />Women
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 cursor-pointer" value={'Children'} onChange={handleCategoryChange} />Children
            </p>
          </div>
        </div>
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 transition-all duration-500 ease-in-out ${showFilter ? 'opacity-100 max-h-[500px]' : 'opacity-0 max-h-0 overflow-hidden'} sm:opacity-100 sm:max-h-none sm:block`}>
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 cursor-pointer" value={'Topwear'} onChange={handleSubCategoryChange} />Topwear
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 cursor-pointer" value={'Bottomwear'} onChange={handleSubCategoryChange} />Bottomwear
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 cursor-pointer" value={'Winterwear'} onChange={handleSubCategoryChange} />Winterwear
            </p>
          </div>
        </div>
      </div>
